package me.dmillerw.duplicants.client.gui;
...
public class GuiDuplicant extends GuiContainer {
    ...
    private static final ResourceLocation GUI_TEXTURE = new ResourceLocation(Duplicants.Info.MOD_ID, "textures/gui/inventory.png");
    ...
    public GuiDuplicant(EntityPlayer entityPlayer, EntityDuplicant entityDuplicant) {
        super(new ContainerDuplicant(entityPlayer, entityDuplicant));
