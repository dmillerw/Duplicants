...
public class GuiDuplicantVisualSettings extends GuiScreen {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(Duplicants.Info.MOD_ID, "textures/gui/settings.png");
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 0) {
            ...
            SSetDuplicantSettings packet = new SSetDuplicantSettings(entityDuplicant.getEntityId(), nameField.getText(), skinField.getText(), showNameplate);
