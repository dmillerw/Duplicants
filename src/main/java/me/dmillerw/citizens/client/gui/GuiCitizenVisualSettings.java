...
import me.dmillerw.citizens.common.network.packet.SSetCitizenSettings;
...
public class GuiCitizenVisualSettings extends GuiScreen {
    ...
    public GuiCitizenVisualSettings(EntityCitizen entityCitizen) {
    ...
    public void initGui() {
        ...
        nameField.setText(entityCitizen.getCitizenName().isPresent() ? entityCitizen.getCitizenName().get() : "");
        skinField = new GuiTextField(1, fontRenderer, guiLeft + 7, guiTop + 89, 110, 16);
        skinField.setText(entityCitizen.getSkin().isPresent() ? entityCitizen.getSkin().get() : "");
